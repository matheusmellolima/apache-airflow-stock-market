...
if __name__ == '__main__':
    ...
    def app():
        ...
        file_location = os.getenv("SPARK_STOCK_PRICES_FILE_LOCATION")

        spark = SparkSession.builder.appName("StockMarketTransform") \
        ...
        df = spark.read.option("header", "false") \
            .json(f"s3a://{file_location}/prices.json")
        ...
        df_zipped.write \
            ...
            .option("header", "true") \
            .option("delimiter", ",") \
            .csv(f"s3a://{file_location}/transform")
